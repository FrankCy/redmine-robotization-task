...
<@html title="" lang="zh-CN">
    ...
    <body>
        ...
        <script type="text/javascript">
            var chart = null;
            function getIssueProportion(proName) {
                $.getJSON('/redmine/getIssueProportion?proName='+proName, function (data) {
            ...
            getIssueProportion("bdjr-pzh");
            getRedmineIssueJson("bdjr-pzh");
        </script>
    </body>
</@html>